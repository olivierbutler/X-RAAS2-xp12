...
#define Value_Unit_TimeDelta		(1<<28)	// 1/10000000 of second
#define Value_Unit_TimeStart		(1<<29)	// 1/10000000 of second
#define Value_Unit_Label			(1<<30)	// ARINC 429 label
//--------------------------------------------------------------------------
